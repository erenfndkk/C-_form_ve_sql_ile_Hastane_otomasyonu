...
namespace Hastane__Proje
{
    public partial class FrmHastaDetay : Form
    {
        ...
        private void FrmHastaDetay_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select * from Tbl_Randevular where RandevuTC=" + tc, bgl.baglanti());
            da.Fill(dt);
        ...
        private void BtnRandevuAl_Click(object sender, EventArgs e)
        {
            ...
            bgl.baglanti().Close();
            MessageBox.Show("randevu alındı", "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
    }
}
